...
export default function KidsJewelryPage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      console.log('🔄 Fetching kids jewelry products...')
      ...
      if (data.success) {
        ...
        // Filter to show only kids jewelry products
        const kidsJewelryProducts = allProducts.filter((product: Product) => {
          const isKidsJewelry = product.category === 'kids' && (
          ...
          console.log(`🔍 Product: ${product.name}, Category: ${product.category}, Subcategory: ${product.subcategory}, Is Kids Jewelry: ${isKidsJewelry}`)
          return isKidsJewelry
        })
        
        console.log(`✅ Found ${kidsJewelryProducts.length} kids jewelry products from ${allProducts.length} total products`)
        setProducts(kidsJewelryProducts)
      } else {
      ...
      <div className="min-h-screen bg-gradient-to-b from-indian-gold/5 via-indian-saffron/5 to-indian-crimson/5">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-indian-maroon font-medium">Loading Kids Jewelry...</p>
          </div>
        </div>
        <Footer />
      </div>
      ...
      <div className="relative bg-gradient-to-br from-indian-gold/20 via-indian-saffron/20 to-indian-crimson/20 py-16 lg:py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-indian-maroon mb-6">
            <span className="block">Kids Jewelry</span>
            <span className="block text-3xl lg:text-5xl text-indian-gold">Children's Collection</span>
          </h1>
          <p className="text-xl text-indian-crimson max-w-3xl mx-auto leading-relaxed">
            Discover our adorable collection of traditional Indian kids jewelry, designed with safety and comfort in mind. 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-indian-crimson">
            {products.length} beautiful kids jewelry pieces to choose from
          </p>
        </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-indian-maroon mb-2">No Kids Jewelry Found</h3>
            <p className="text-indian-crimson mb-6">We're currently updating our kids jewelry collection. Please check back soon!</p>
            <button 
              onClick={fetchProducts}
