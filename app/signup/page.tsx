...
export default function SignupPage() {
  const { signup, loginWithGoogle, user, loading: authLoading } = useFirebaseAuth()
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-bold text-gray-900">
                ਨਵਾਂ ਖਾਤਾ - Create Account
              </CardTitle>
              <CardDescription className="text-gray-600">
                Join us to explore authentic Punjabi heritage
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  {formData.confirmPassword && (
                    <div className="text-xs">
                      <div className={`flex items-center ${passwordValidation.match ? 'text-green-600' : 'text-red-600'}`}>
