    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-amber-700 font-medium">Culture Hatti Store Management</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-green-50 rounded-lg border-2 border-green-200">
          <h3 className="text-sm font-semibold text-green-900 mb-2">Default Admin Credentials:</h3>
          <div className="text-sm text-green-800 space-y-1">
            <p><strong>Email:</strong> harshdevsingh2004@gmail.com</p>
            <p><strong>Password:</strong> admin123</p>
          </div>
          <p className="text-xs text-green-700 mt-2">
            Use these credentials to access the admin panel and manage products.
          </p>
        </div>
