...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const loadData = () => {
      const productsData = productStorage.getAllProducts()
      const statsData = productStorage.getProductStats()
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats.totalProducts === 0 ? 'No products yet' : 'Products in catalog'}
            </p>
          </CardContent>
        </Card>
